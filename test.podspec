...
Pod::Spec.new do |spec|
  ...
  spec.author             = { "Tanapakorn" => "tanapakorn_lao@truecorp.co.th" }
  # Or just: spec.author    = "Tanapakorn"
  # spec.authors            = { "Tanapakorn" => "tanapakorn_lao@truecorp.co.th" }
  # spec.social_media_url   = "https://twitter.com/Tanapakorn"
